...
! function (e) {
   ...
   e.nanogallery2 = function (e, t) {
      ...
      icons: {
         ...
         navigationFilterSelected: '<i style="color:var(--design-500);" class="nGY2Icon-ok"></i>',
         navigationFilterUnselected: '<i style="color:#ddd;opacity:0.3;" class="nGY2Icon-circle-empty"></i>',
         navigationFilterSelectedAll: '<i class="ti-reload"></i>',
         ...
         thumbnailDisplay: '<i class="ti-fullscreen"></i>',
         ...
         buttonClose: '<i class="flaticon-close"></i>',
         viewerPrevious: '<i class="nGY2Icon-ngy2_chevron-left"></i>',
         viewerNext: '<i class="nGY2Icon-ngy2_chevron-right"></i>',
         viewerImgPrevious: '<i class="flaticon-back-1"></i>',
         viewerImgNext: '<i class="flaticon-next"></i>',
         ...
         viewerPlay: '<i class="flaticon-back-3"></i>',
         viewerPause: '<i class="nGY2Icon-pause"></i>',
         viewerFullscreenOn: '<i class="ti-fullscreen"></i>',
         viewerFullscreenOff: '<i class="ti-gallery"></i>',
         ...
         viewerRotateLeft: '<i class="ti-reload"></i>',
         viewerRotateRight: '<i class="ti-reload"></i>',
